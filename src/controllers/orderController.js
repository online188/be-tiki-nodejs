...
const orderController = {
    ...
    filterOrderPagination: async (req, res) => {
        try {
            let result = await orderService.filterOrderPagination(req.query);
            res.status(200).json({
                errCode: 0,
                errMessage: 'Filter order success',
                result,
    ...
    // searchOrder and Pagination
    searchOrder: async (req, res) => {
        try {
            let result = await orderService.searchOrder(req.query);
            res.status(200).json({
                errCode: 0,
                errMessage: 'Filter order success',
                result,
